                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-5">
                            ...
                            <img id="<?php echo e($idPrefix); ?>-img-preview" 
                                 src="<?php echo e(asset('storage/' . ($produk->gambar ?? 'default.png'))); ?>" 
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="d-flex flex-wrap gap-2 mb-3">
                                <?php $__currentLoopData = \App\Models\Produk::WARNA_OPTIONS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $warna): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        // Cari gambar varian warna ini
                                        $varWarna = $produk->varians->firstWhere('warna', $warna);
                                        $imgWarna = $varWarna && $varWarna->gambar ? asset('storage/' . $varWarna->gambar) : asset('storage/' . $produk->gambar);
                                    ?>
...
(function() {
    ...
    function updateVarianInfo() {
        ...
        if (imgRadio) {
            document.getElementById(`${prefix}-img-preview`).src = imgRadio;
        }
...
</script><?php /**PATH C:\Users\DELL\Downloads\fashion-sales-new (2)\fashion-sales-terbaru\resources\views/customer/partials/_produk_modal.blade.php ENDPATH**/ ?>