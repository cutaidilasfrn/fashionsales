...
<body>
            ...
            <div>
                ...
                <ul class="nav nav-pills flex-column mt-3">
                    <?php if(auth()->user()->role === 'admin'): ?>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('transaksi.index')); ?>" class="nav-link <?php echo e(request()->is('transaksi*') ? 'active' : ''); ?>">
    ...
    <main class="main-content <?php if(auth()->guard()->guest()): ?> full-width <?php endif; ?>">
        <?php if(auth()->guard()->check()): ?>
            <?php if(auth()->user()->role === 'admin' && ((isset($stokMenipisList) && $stokMenipisList->count() > 0) || (isset($pesananBaruList) && $pesananBaruList->count() > 0))): ?>
                <nav class="d-flex justify-content-end gap-2 px-3 pt-3">
                    <?php if(isset($pesananBaruList) && $pesananBaruList->count() > 0): ?>
                        <div class="dropdown">
                    ...
                    <?php if(isset($stokMenipisList) && $stokMenipisList->count() > 0): ?>
                    <div class="dropdown">
                        <button class="btn btn-light border position-relative" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <div class="dropdown-menu dropdown-menu-end shadow-sm p-0" style="min-width: 320px;">
                            ...
                            <ul class="list-unstyled mb-0" style="max-height: 280px; overflow-y: auto;">
                                <?php $__currentLoopData = $stokMenipisList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="px-3 py-2 border-bottom d-flex justify-content-between align-items-center">
                                        <span class="text-truncate me-2"><?php echo e($p->nama_produk); ?></span>
                                        <span class="badge <?php echo e($p->stok == 0 ? 'bg-danger' : 'bg-warning text-dark'); ?>">
                                            <?php echo e($p->stok == 0 ? 'Habis' : $p->stok . ' tersisa'); ?>
...
</html><?php /**PATH C:\xampp\htdocs\fashion-sales\resources\views/layouts/app.blade.php ENDPATH**/ ?>