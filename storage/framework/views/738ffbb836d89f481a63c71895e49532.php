        ...
        <div class="card-body p-4">
            ...
            <form action="<?php echo e(route('customer.profil.update')); ?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="kota" class="form-control" value="<?php echo e(old('kota', $pelanggan->kota)); ?>" placeholder="Kota domisili" required>
                </div>

                <div class="mb-3">
                    <label class="form-label">Alamat Lengkap <span class="text-danger">*</span></label>
                    <textarea name="alamat" class="form-control" rows="3" placeholder="Alamat pengiriman" required><?php echo e(old('alamat', $pelanggan->alamat)); ?></textarea>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Cut Aidila Safriana\Downloads\fashion-sales-terbaru-fixed\resources\views/customer/profil.blade.php ENDPATH**/ ?>