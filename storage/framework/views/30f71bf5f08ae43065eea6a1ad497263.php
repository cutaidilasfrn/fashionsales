...
<?php if($errors->has('batal') || $errors->has('status') || $errors->has('alasan_pembatalan')): ?>
    <div class="alert alert-danger"><?php echo e($errors->first('batal') ?? $errors->first('status') ?? $errors->first('alasan_pembatalan')); ?></div>
<?php endif; ?>
...
<div class="card border-0 shadow-sm mb-4">
    ...
    <div class="card-body">
        ...
        <?php if($pesanan->status_pesanan === 'Batal'): ?>
            <div class="alert alert-danger mt-3 mb-0">
                <strong>Pesanan ini dibatalkan <?php echo e(match($pesanan->dibatalkan_oleh) {
                    'admin' => 'oleh admin',
                    'sistem' => 'otomatis oleh sistem karena tidak dibayar dalam 1x24 jam',
                    default => 'oleh kamu sendiri',
                }); ?>.</strong>
                <?php if($pesanan->alasan_pembatalan): ?>
                    <div class="mt-1">Alasan: <?php echo e($pesanan->alasan_pembatalan); ?></div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
    </div>
    ...
    <div class="card border-0 shadow-sm mb-4">
        ...
        <div class="card-body">
            ...
            <?php else: ?>
                ...
                <?php $batasBayar = $pesanan->batasWaktuBayar(); ?>
                <?php if($batasBayar): ?>
                    <div class="alert alert-warning d-flex align-items-center gap-2 mb-3">
                        <i class="bi bi-clock-history fs-5"></i>
                        <div>
                            Bayar sebelum <strong><?php echo e($batasBayar->format('d M Y H:i')); ?></strong>
                            (<span class="countdown-timer fw-bold" data-deadline="<?php echo e($batasBayar->toIso8601String()); ?>">menghitung...</span>),
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Cut Aidila Safriana\Downloads\fashion-sales-terbaru-fixed\resources\views/customer/pesanan_show.blade.php ENDPATH**/ ?>