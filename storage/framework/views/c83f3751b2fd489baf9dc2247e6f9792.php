            ...
            <div class="col-md-3 mb-4">
                <div class="card h-100 shadow-sm border-0">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <?php else: ?>
                            <small class="text-muted">Sisa stok: <?php echo e($produk->total_stok); ?></small>
                        <?php endif; ?>

                        <div class="d-flex gap-2 mt-2">
                            <button type="button" class="btn btn-outline-primary flex-fill" data-bs-toggle="modal" data-bs-target="#cartModal<?php echo e($produk->id); ?>" <?php echo e($produk->total_stok <= 0 ? 'disabled' : ''); ?>>
                                <i class="bi bi-cart-plus"></i> Keranjang
                            </button>
                            <button type="button" class="btn btn-primary flex-fill" data-bs-toggle="modal" data-bs-target="#orderModal<?php echo e($produk->id); ?>" <?php echo e($produk->total_stok <= 0 ? 'disabled' : ''); ?>>
                                Beli Sekarang
                            </button>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Cut Aidila Safriana\Downloads\fashion-sales-terbaru-fixed\resources\views/customer/katalog.blade.php ENDPATH**/ ?>