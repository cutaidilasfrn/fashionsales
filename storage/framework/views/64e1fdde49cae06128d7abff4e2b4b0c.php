...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('customer.katalog')); ?>" class="btn btn-outline-secondary">Lihat Semua Produk</a>
    </div>
            ...
            <?php $__currentLoopData = $produks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-3 mb-4">
                    <div class="card h-100 shadow-sm border-0 position-relative">
                        <span class="badge bg-danger position-absolute top-0 start-0 m-2" style="z-index: 2;">-<?php echo e($produk->diskon_persen); ?>%</span>
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="d-flex gap-2 mt-2">
                                <button type="button" class="btn btn-outline-danger flex-fill" data-bs-toggle="modal" data-bs-target="#promoCartModal<?php echo e($produk->id); ?>" <?php echo e($produk->stok <= 0 ? 'disabled' : ''); ?>>
                                    <i class="bi bi-cart-plus"></i> Keranjang
                                </button>
                                <button type="button" class="btn btn-danger flex-fill" data-bs-toggle="modal" data-bs-target="#promoOrderModal<?php echo e($produk->id); ?>" <?php echo e($produk->stok <= 0 ? 'disabled' : ''); ?>>
                                    Beli Sekarang
                                </button>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Cut Aidila Safriana\Downloads\fashion-sales-terbaru\resources\views/customer/promo.blade.php ENDPATH**/ ?>